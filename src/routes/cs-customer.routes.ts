...
router.get(
    '/profile',
    asyncHandler(customerProfileController.getProfile.bind(customerProfileController))
);
...
router.post('/confirm-phone', 
    asyncHandler(customerProfileController.confirmPhone.bind(customerProfileController)));
